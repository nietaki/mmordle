defmodule MmordleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MmordleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MmordleWeb.Gettext, "errors", msg, opts)
    end
  end
